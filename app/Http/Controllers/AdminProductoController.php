<?php namespace App\Http\Controllers;
	...
	class AdminProductoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    ...
	    public function listado(){
            return response()->json(Producto::select(["id","codigo","descripcion","precio",DB::raw("CONCAT(codigo,' ',descripcion) AS nombre")])->get());
        }
