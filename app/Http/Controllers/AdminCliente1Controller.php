<?php namespace App\Http\Controllers;
	...
	class AdminCliente1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"RSOCIAL","name"=>"RSOCIAL"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'CI/RUC','name'=>'ruc','type'=>'number','validation'=>'required|min:10','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'TELEFONO','name'=>'TELEFONO','type'=>'number','validation'=>'required|min:7','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'RSOCIAL','name'=>'RSOCIAL','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'DIRECCION','name'=>'DIRECCION','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'TELEFONO','name'=>'TELEFONO','type'=>'number','validation'=>'required|min:10','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'CIUDAD','name'=>'CIUDAD','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
